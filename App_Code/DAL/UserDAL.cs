            ...
            using (SqlConnection objConn = new SqlConnection(ConnectionString))
            {
                ...
                using (SqlCommand objCmd = objConn.CreateCommand())
                {
                    try
                    {
                        ...
                        objCmd.Parameters.Add("@Mobile", SqlDbType.VarChar).Value = entUser.Mobile;
                        objCmd.Parameters.Add("@CreationDate", SqlDbType.DateTime).Value = entUser.CreationDate;
                        objCmd.Parameters.Add("@ModificationDate", SqlDbType.DateTime).Value = entUser.ModificationDate;
