...
<script RunAt="server">
    ...
    public static void RegisterRoutes(System.Web.Routing.RouteCollection routes)
    {
        ...
        //1. String - Route Name : AdminPanelCountryList
        //2. String - Route URL : AdminPanel/Country/List
        //3. String - Physical File : ~/AdminPanel/Country/CountryList.aspx
        ...
        routes.MapPageRoute("AdminPanelLogin", "AdminPanel/Login", "~/AdminPanel/Login.aspx");
        routes.MapPageRoute("AdminPanelCreateAccount", "AdminPanel/Register", "~/AdminPanel/CreateAccount.aspx");
        routes.MapPageRoute("AdminPanelDefault", "AdminPanel/Home", "~/AdminPanel/Default.aspx");
    }
