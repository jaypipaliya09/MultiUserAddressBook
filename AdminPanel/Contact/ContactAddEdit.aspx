...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="Server">
    <div class="row" align="justify">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <asp:DropDownList runat="server" ID="ddlCountryID" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList><br />
            </div>
            <div class="col-md-2">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <asp:DropDownList runat="server" ID="ddlStateID" AutoPostBack="True" OnSelectedIndexChanged="ddlStateID_SelectedIndexChanged"></asp:DropDownList><br />
            </div>
            <div class="col-md-2">
        ...
        <div class="row" ID="PhotoUpload" runat="server">
            <div class="col-md-4">
